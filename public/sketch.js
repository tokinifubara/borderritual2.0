...
function preload() {
	...
	soundtrack2 = loadSound(
		'assets/Sprites/Misc/Video Game Death - Lose Life Sound Effect.mp3',
	);
...
function setup() {
	...
	cutsceneland = loadAnimation(
		'assets/Sprites/CutScene/cutscene30.png',
		'assets/Sprites/CutScene/cutscene60.png',
	);
	cutscenefail = loadAnimation(
		'assets/Sprites/CutScene/cutscene61.png',
		'assets/Sprites/CutScene/cutscene99.png',
	);
	cutsceneend = loadAnimation(
		'assets/Sprites/CutScene/cutscene100.png',
		'assets/Sprites/CutScene/cutscene129.png',
	);
	cutsceneleave = loadAnimation(
	...
	if (playScreen === 0) {
		...
		if (!gameOver) {
			...
			if (random() < 1 / 190) {
				...
				paper.addAnimation(
					'scan',
					'assets/Sprites/Misc/Paper1.png',
					'assets/Sprites/Misc/Paper18.png',
				);
				papers.add(paper);
			}
			...
			for (var n = 0; n < queues.length; n++)
				if (queues[n].position.x < nkechi.position.x - 1500) queues[n].remove();
			...
			if (random() < 1 / 300) {
				...
				coin.addAnimation(
					'pic',
					'assets/Sprites/Misc/coin/coin1.png',
					'assets/Sprites/Misc/coin/coin19.png',
				);
				coins.add(coin);
			}
...
function draw_Hint() {
	...
	fill(62, 112, 155);
	text(
		'To cross the border collect 20 Trickster Tokens\nClick to Jump and avoid the scanners',
		width / 2,
		height / 2 + 240,
	);
	fill(255, 201, 23);
